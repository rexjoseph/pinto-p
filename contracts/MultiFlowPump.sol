...
import {IPump} from "./interfaces/basin/pumps/IPump.sol";
import {IMultiFlowPumpErrors} from "./interfaces/basin/pumps/IMultiFlowPumpErrors.sol";
import {IWell, Call} from "./interfaces/basin/IWell.sol";
import {IInstantaneousPump} from "./interfaces/basin/pumps/IInstantaneousPump.sol";
import {IMultiFlowPumpWellFunction} from "./interfaces/basin/pumps/IMultiFlowPumpWellFunction.sol";
import {ICumulativePump} from "./interfaces/basin/pumps/ICumulativePump.sol";
import {ABDKMathQuad} from "./libraries/ABDKMathQuad.sol";
import {LibBytes16} from "./libraries/LibBytes16.sol";
import {LibLastReserveBytes} from "./libraries/LibLastReserveBytes.sol";
...
contract MultiFlowPump is IPump, IMultiFlowPumpErrors, IInstantaneousPump, ICumulativePump {
    ...
    function _capLpTokenSupply(
        ...
        // If the last or current LP Token Supply is MAX_UINT256_SQRT, return the capped reserves.
        if (lastLpTokenSupply == MAX_UINT256_SQRT || lpTokenSupply == MAX_UINT256_SQRT) {
            return cappedReserves;
        }
