...
contract BasinDeployer is Utils {
    ...
    function deployWellAtAddress(
        ...
        if (targetAddress != address(0)) {
            ...
            copyContractState(wellAddress, targetAddress);
    ...
    // this copies the first 100 slots of the source contract to the target contract.
    function copyContractState(address source, address target) internal {
        uint256 slot = 0;
